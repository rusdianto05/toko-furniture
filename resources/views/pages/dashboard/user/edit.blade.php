            ...
            <div class="">
                @if ($errors->any())
                    <div class="mb5" role="alert">
                        <div class="bg-red500 text-white font-bold rounded-t px-4 py-2">
                ...
                <form action="{{ route('dashboard.user.update', $item->id) }}" class="w-full" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap mx-3 mb-6">
                        <div class="w-full px-3">
                            ...
                            <input type="email" value="{{  old('name') ?? $item->email }}" name="email" placeholder="User Email" class="block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" >
                        </div>
                        </div>
                        <div class="flex flex-wrap mx-3 mb-6">
                        <div class="w-full px-3">
