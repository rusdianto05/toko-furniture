          ...
          <div class="flex flex-stretch items-center">
            <div class="w-56 items-center flex">
              <a href="{{ Route('index')}}">
                ...
                alt="Toko Furniture | Furniture Modern dan Elegan Untuk Anda"
              />
              </a>
            </div>
            ...
            <div class="w-auto">
              ...
              >
                ...
                <li class="mx-3 py-6 md:py-0">
                  <a href="{{ route('about') }}" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline"
                    >About</a
                  >
                </li>
                <li class="mx-3 py-6 md:py-0">
                  <a href="{{ route('help') }}" class="text-black {{ \Route::current()->getName() == 'index' ? 'md:text-white' : 'md:text-black' }} hover:underline"
                    >Help</a
                  >
                </li>
