...
use App\Http\Controllers\MyTransactionController as ControllersMyTransactionController;
        ...
        if (request()->ajax()) {
            ...
            return DataTables::of($query)
                ->addColumn('action', function ($item) {
                    return '
                    <a class="bg-gray-500 text-white rounded-md px-2 py-1 m-2" href="' . route('dashboard.transaction.show', $item->id) . '">
                        Show
                    </a>';
                })
